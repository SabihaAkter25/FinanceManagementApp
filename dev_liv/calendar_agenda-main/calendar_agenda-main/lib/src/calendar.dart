...
class CalendarAgenda extends StatefulWidget implements PreferredSizeWidget {
  ...
  final ImageProvider? selectedDayLogo;
  final Widget? eventLogo;
  final ImageProvider? selectedEventLogo;
  ...
  CalendarAgenda({
   ...
   required this.decoration,
    this.selectDecoration, this.eventLogo, this.selectedEventLogo,
  })  : assert(
              ...
              return Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      fontSize: 22.0,
                      color: isSelected ? widget.selectedDateColor : widget.headerDateColor,
                  ...
                  _eventDates.contains(date.toString().split(" ").first)
                      ...
                      ? widget.selectedEventLogo! as Widget
  ...
  void showFullCalendar() {
    showModalBottomSheet<void>(
      ...
      builder: (BuildContext context) {
        ...
        bool isSelected = _selectedDate == _dates;
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                width: 60,
                height: 6,
                decoration: isSelected && widget.selectDecoration != null
